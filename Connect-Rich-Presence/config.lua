...
Button1Text = 'Join Our Discord!', -- Text that will appear on the first button
Button1Link = 'https://discord.gg/ehhgcKvc7t', -- Link that will open when pressing the first button
Button2Text = 'GitHub', -- Text that will appear on the second button
Button2Link = 'https://github.com/predict-development' -- Link that will open when pressing the second button.
}
